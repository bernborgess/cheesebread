...
function(compile_rtlib target_name)
    ...
    if(ANDROID AND RTLIBS_TARGET MATCHES "^arm-linux-android")
        string(REPLACE "arm-linux-android" "armv7a-linux-androideabi" RTLIBS_TARGET ${RTLIBS_TARGET})
    endif()
    ...
    if(EXISTS ${CMAKE_CURRENT_SOURCE_DIR}/llvm-project)
        ...
        if(CANGJIE_USE_OH_LLVM_REPO)
            set(REPOSITORY_PATH "https://github.com/openharmony/third_party_llvm-project.git")
            set(LLVM_TAG master)
        else()
            set(REPOSITORY_PATH "https://github.com/cangjielanguage/llvm-project.git")
            set(LLVM_TAG dev)
        endif()
